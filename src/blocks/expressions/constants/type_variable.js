 ...
 * @fileoverview Constant Type Variable 
 */
...
Blockly.Blocks["BlockConstTypeVariable"] = {
  init: function () {
    this.syntaxType = "exp";
    ...
    this.appendDummyInput("mainInput").appendField("", "terminal");
  ...
  onchange: function () {
    ...
    else this.setFieldValue("", "terminal");
