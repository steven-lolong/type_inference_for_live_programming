 ...
 * @fileoverview Expression Boolean Operators - logic compare
 */
...
Blockly.Blocks["BlockOperatorBooleanCompare"] = {
  init: function () {
    this.syntaxType = "exp";
    ...
    this.expectedLhs = { key: "primitive", value: "boolean" };
    this.expectedRhs = { key: "primitive", value: "boolean" };

    this.appendValueInput("lhs").setCheck("exp").appendField("Logic")
  ...
  evaluator: function () {
    ...
    if (typeof lhsValue === 'boolean' && typeof rhsValue === 'boolean') {
      switch (operator) {
        case "and":
